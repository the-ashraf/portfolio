...
<template>
		...
		<div class="grid md:grid-cols-2 gap-4 p-10">
			...
			<div class="relative order-1 md:order-2">
				<div class="w-full h-60 md:h-full md:w-full md:absolute md:-top-10">
					<img class="w-full h-full object-cover object-top md:w-auto md:h-auto md:rounded-t-md" src="/clients/nour.png" alt="Screenshot of the Al-nour trading homepage">
				</div>
			</div>
		</div>
	</SiteHeader>
	...
	<main class="max-w-6xl mx-auto pt-10 space-y-6 px-8">
		<div class="flex justify-between">
			...
			<div class="py-3 px-4 border rounded-md border-gray-300 font-bold text-center">Vue Router</div>
		</div>
		...
		<div class="grid grid-cols-4 gap-4">
			...
			<div class="relative">
				<div class="w-full h-full space-y-4">
					<img @click.prevent="handleClick($event)" class="block rounded-md border cursor-pointer" src="/clients/nour/nour_body.png" alt="Screenshot of the Al-Nour tading profile website">
				</div>
			</div>
		</div>
	</main>
